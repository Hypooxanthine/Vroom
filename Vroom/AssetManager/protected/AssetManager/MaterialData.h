...
namespace vrm
{
  ...
  class VRM_ASSETMANAGER_API MaterialData
  {
  public:
...
namespace nlohmann
{
  ...
  void VRM_ASSETMANAGER_API to_json(json& j, const vrm::MaterialData::Parameter& e);
  void VRM_ASSETMANAGER_API from_json(const json& j, vrm::MaterialData::Parameter& e);

  void VRM_ASSETMANAGER_API to_json(json& j, const vrm::MaterialData& e);
  void VRM_ASSETMANAGER_API from_json(const json& j, vrm::MaterialData& e);
