...
class VRM_RENDERER_API MaterialDefines
{
public:
...
public:
  ...
  MaterialDefines& operator=(MaterialDefines&& other) = default;
  MaterialDefines(MaterialDefines&& other)            = default;

  void add(const std::string& define, std::string&& value = "");
  void add(const MaterialDefines& defines);
