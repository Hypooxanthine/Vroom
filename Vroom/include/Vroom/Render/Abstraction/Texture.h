...
namespace vrm::gl
{
  ...
  inline constexpr GLint Texture::GetBasicColorInternalFormat(GLuint channelCount, GLuint bitsPerChannel)
  {
    ...
    {
      case 8:  bitsIndex = 0; break;
      case 16: bitsIndex = 1; break;
      case 32: bitsIndex = 2; break;
      default:
