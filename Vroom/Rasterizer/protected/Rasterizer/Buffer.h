...
class VRM_RASTERIZER_API Buffer
{
public:
...
public:
  ...
  inline static void Bind(const Buffer& buffer, GLenum target)
  {
    Bind(buffer.getRenderId(), target);
  }
  ...
  inline Desc getDescription() const
  {
    return m_desc;
  }
  inline GLsizeiptr getCapacity() const
  {
