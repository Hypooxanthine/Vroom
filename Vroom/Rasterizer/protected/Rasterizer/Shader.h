...
class VRM_RASTERIZER_API Shader
{
public:
...
public:
  ...
  inline void setUniform2f(const GLString& name, const glm::vec2& vec) const
  {
  ...
  inline void setUniform4f(const GLString& name, const glm::vec4& vec) const
  {
