...
class VRM_RASTERIZER_API OwningFrameBuffer : public FrameBuffer
{
public:

  inline OwningFrameBuffer() : FrameBuffer()
  {}
  ...
  inline void setColorAttachment(GLuint slot, GLuint channels,
