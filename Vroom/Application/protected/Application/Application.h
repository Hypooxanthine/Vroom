 ...
 * @brief This is the core class of the engine. Everything related to the engine - including static calls - need to be
 * done AFTER creation of Application instance (it will initialize everything needed).
 *
 */
class VRM_APPLICATION_API Application
{
public:
   ...
   */
  inline const GameLayer& getGameLayer() const
  {
    return *m_GameLayer;
  }
   ...
   */
  inline const DeltaTime& getDeltaTime() const
  {
    return m_DeltaTime;
  }
  ...
  inline uint16_t getFrameRateLimit() const
  {
