...
public:
  ...
  public:
    ...
    Iterator(Container::iterator it) : m_Iterator(it)
    {}
  ...
  public:
    ...
    ReverseIterator(Container::reverse_iterator it) : m_Iterator(it)
    {}
...
public:
  ...
  {
    return ReverseIterator(m_Layers.rbegin());
  }
  ...
  {
    return ReverseIterator(m_Layers.rend());
  }
