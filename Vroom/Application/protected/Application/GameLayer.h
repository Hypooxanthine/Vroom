 ...
 *
 */
class VRM_APPLICATION_API GameLayer : public Layer
{
public:
  ...
  {
    return m_CurrentScene.get() != nullptr;
  }
   ...
   * @return TriggerBinder The binder of the trigger. Handful for binding inputs and callbacks to a trigger after its
   * creation.
   * @see @ref triggers
   */
   ...
   * @return CustomEventBinder The binder of the trigger. Handful for binding inputs and callbacks to a custom event
   * after its creation.
