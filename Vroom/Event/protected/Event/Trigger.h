...
#include "Event/Api.h"
#include "Event/TriggerCallbackList.h"
...
public:
   ...
   */
  inline void bindCallback(const TriggerCallback& cb, TriggerBinder* emitter)
  {
    m_Callbacks.addCallback(cb, emitter);
  }

  inline void removeCallbacksFromEmitter(TriggerBinder* emitter)
  {
