...
#include "Event/Api.h"
#include "Event/CustomEventCallbackList.h"
 ...
 *
 */
class VRM_EVENT_API CustomEvent
{
public:
   ...
   */
  void addCallback(const CustomEventCallback& cb, CustomEventBinder* emitter)
  {
    m_Callbacks.addCallback(cb, emitter);
  }
  ...
  {
    m_Callbacks.triggerAll(e);
  }

  void removeCallbacksFromEmitter(CustomEventBinder* emitter)
  {
    m_Callbacks.unbindAllFromEmitter(emitter);
  }
